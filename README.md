...
* [Custom Syntax](https://github.com/toolkitchen/mdv/blob/master/examples/how_to/custom_syntax.html): How to implement a custom element which has a specialized interpretation of a binding.
...
* `Node.prototype.bind`: Which describes how DOM nodes are bound to data values
